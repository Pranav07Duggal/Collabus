    ...
    <div className="flex flex-col p-6">
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="bg-radial from-red-500 to-red-800 relative hidden md:flex flex-col gap-y-4 items-center justify-center">
            <img src="/logo.svg" alt="logo" className="h-[92px] w-[92px]" />
            <p className="text-2xl text-white font-semibold">CollabUs</p>
          </div>
        </CardContent>
      </Card>
